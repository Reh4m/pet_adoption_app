...
class LightTheme {
  ...
  static const Color primaryColorLight = Color(0xFFF6CACC);
  ...
  static const Color titleTextColor = Color(0xFF111827);
  static const Color subtitleTextColor = Color(0xFF374151);
  static const Color primaryTextColor = Color(0xFF4B5563);
